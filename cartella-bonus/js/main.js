...
//selezione classi bottoni
const AddButton = document.querySelector(".invio");
// const RemoveButton = document.querySelector(".cancella");
...
AddButton.addEventListener("click",
    function() {
        ...
        addTable.innerHTML = "<h3>" + "DETTAGLI PASSEGGERI" + "</h3>" + "<table>" + "<tbody>"
            + "<tr>" + "<th>" + "Nome e cognome" + "</th>" + "<th>" + "Carrozza" + "</th>" + "<th>" + "Codice CP" + "</th>" + "<th>" + "Offerta" + "</th>" + "<th>" + "Costo biglietto" + "</th>" + "</tr>"
